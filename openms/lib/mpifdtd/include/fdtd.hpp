...
void check_periodicity_Efield();
void check_periodicity_Hfield();

void update_Efield_aux();
void update_Hfield_aux();

void update_CPML_PsiH();
void update_CPML_PsiE();
...
// io
// Declaration of the custom print function
...
// mpi variables
#ifdef MPION
extern MPI_Comm   mpi_grid_comm;
#endif
extern int   mpi_rank, mpi_size;
extern int   mpi_nxprocs, mpi_nyprocs, mpi_nzprocs, mpi_grid_proces[3];
extern int   mpi_grid_coords[3];
extern int   mpi_grid_n1[3];
extern int   mpi_grid_n2[3];

extern int   mpi_efield_isend, mpi_efield_irecv, mpi_efield_jsend, mpi_efield_jrecv;
extern int   mpi_efield_ksend, mpi_efield_krecv, mpi_hfield_isend, mpi_hfield_irecv;
extern int   mpi_hfield_jsend, mpi_hfield_jrecv, mpi_hfield_ksend, mpi_hfield_krecv;
...
/// in parameter.c ///
extern int mygrid_nx, mygrid_ny, mygrid_nz;
extern int grid_size[3];
...
extern int m_mygrid_nx, m_mygrid_ny, m_mygrid_nz;
extern int p_mygrid_nx, p_mygrid_ny, p_mygrid_nz;
extern int c_mygrid_nx, c_mygrid_ny, c_mygrid_nz;
...
extern float *mygrid_x, *mygrid_y, *mygrid_z;
