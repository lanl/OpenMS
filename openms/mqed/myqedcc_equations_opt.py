...
#
# copied from ../../utlities/wick/opt/myqedcc_equations_opt.py
#
import sys
import numpy
import math
...
def qedccsd_T1(F, I, w, g, h, G, H, nfock1, nfock2, amps, imds):
    ...
    T1 += -1.0*einsum('ajbc,ci,bj->ai',I.vovv, T1old, T1old, optimize=True)

    T1 += -1.0*einsum('ajbi,bj->ai',I.vovo, T1old, optimize=True)
    ...
    T1 += 0.5*einsum('ajbc,cbji->ai',I.vovv, T2old, optimize=True)
...
def qedccsd_T2(F, I, w, g, h, G, H, nfock1, nfock2, amps, imds):
    ...
    T2 += 1.0*einsum('akji,bk->abij',I.vooo, T1old, optimize=True)
    T2 += -1.0*einsum('bkji,ak->abij',I.vooo, T1old, optimize=True)
    T2 += 1.0*einsum('baci,cj->abij',I.vvvo, T1old, optimize=True)
    T2 += -1.0*einsum('bacj,ci->abij',I.vvvo, T1old, optimize=True)
    T2 += 1.0*einsum('akci,bckj->abij',I.vovo, T2old, optimize=True)
    T2 += -1.0*einsum('akcj,bcki->abij',I.vovo, T2old, optimize=True)
    T2 += -1.0*einsum('bkci,ackj->abij',I.vovo, T2old, optimize=True)
    T2 += 1.0*einsum('bkcj,acki->abij',I.vovo, T2old, optimize=True)
    ...
    T2 += 1.0*einsum('akci,cj,bk->abij',I.vovo, T1old, T1old, optimize=True)
    T2 += -1.0*einsum('akcj,ci,bk->abij',I.vovo, T1old, T1old, optimize=True)
    T2 += -1.0*einsum('bkci,cj,ak->abij',I.vovo, T1old, T1old, optimize=True)
    T2 += 1.0*einsum('bkcj,ci,ak->abij',I.vovo, T1old, T1old, optimize=True)
    ...
    T2 += -0.5*einsum('akcd,bk,dcji->abij',I.vovv, T1old, T2old, optimize=True)
    T2 += 1.0*einsum('akcd,di,bckj->abij',I.vovv, T1old, T2old, optimize=True)
    T2 += -1.0*einsum('akcd,dj,bcki->abij',I.vovv, T1old, T2old, optimize=True)
    T2 += 1.0*einsum('akcd,dk,bcji->abij',I.vovv, T1old, T2old, optimize=True)
    T2 += 0.5*einsum('bkcd,ak,dcji->abij',I.vovv, T1old, T2old, optimize=True)
    T2 += -1.0*einsum('bkcd,di,ackj->abij',I.vovv, T1old, T2old, optimize=True)
    T2 += 1.0*einsum('bkcd,dj,acki->abij',I.vovv, T1old, T2old, optimize=True)
    T2 += -1.0*einsum('bkcd,dk,acji->abij',I.vovv, T1old, T2old, optimize=True)
    ...
    T2 += 1.0*einsum('akcd,di,cj,bk->abij',I.vovv, T1old, T1old, T1old, optimize=True)
    T2 += -1.0*einsum('bkcd,di,cj,ak->abij',I.vovv, T1old, T1old, T1old, optimize=True)
...
def qedccsd_U1n(F, I, w, g, h, G, H, nfock1, nfock2, amps, imds):
    ...
    U1n[0] += 1.0*einsum('ajbc,cj,Ibi->Iai',I.vovv, T1old, U1nold[0], optimize=True)
    ...
    U1n[0] += -1.0*einsum('ajbi,Ibj->Iai',I.vovo, U1nold[0], optimize=True)
    ...
    U1n[0] += -1.0*einsum('ajbc,ci,Ibj->Iai',I.vovv, T1old, U1nold[0], optimize=True)
    ...
    if U2nold[0] is not None:
        ...
        U1n[0] += 0.5*einsum('ajbc,Icbji->Iai',I.vovv, U2nold[0], optimize=True)
    ...
    U1n[1] += -1.0*einsum('ajbi,IJbj->IJai',I.vovo, U1nold[1], optimize = True)
    if U2nold[0] is not None:
        ...
        U1n[1] += 0.5*einsum('ajbc,IJcbji->IJai',I.vovv, U2nold[1], optimize = True)
    ...
    U1n[1] += -1.0*einsum('ajbc,ci,IJbj->IJai',I.vovv, T1old, U1nold[1], optimize = True)
    U1n[1] += 1.0*einsum('ajbc,cj,IJbi->IJai',I.vovv, T1old, U1nold[1], optimize = True)
    U1n[1] += -1.0*einsum('ajbc,Ici,Jbj->IJai',I.vovv, U1nold[0], U1nold[0], optimize = True)
    U1n[1] += 1.0*einsum('ajbc,Icj,Jbi->IJai',I.vovv, U1nold[0], U1nold[0], optimize = True)
...
def qedccsd_U2n(F, I, w, g, h, G, H, nfock1, nfock2, amps, imds):
    ...
    U2n[0] += 1.0*einsum('akji,Ibk->Iabij',I.vooo, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bkji,Iak->Iabij',I.vooo, U1nold[0], optimize = True)
    U2n[0] += 1.0*einsum('baci,Icj->Iabij',I.vvvo, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bacj,Ici->Iabij',I.vvvo, U1nold[0], optimize = True)
    U2n[0] += -0.5*einsum('klji,Ibalk->Iabij', I.oooo, U2nold[0], optimize = True)
    U2n[0] += 1.0*einsum('akci,Ibckj->Iabij',I.vovo, U2nold[0], optimize = True)
    U2n[0] += -1.0*einsum('akcj,Ibcki->Iabij',I.vovo, U2nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bkci,Iackj->Iabij',I.vovo, U2nold[0], optimize = True)
    U2n[0] += 1.0*einsum('bkcj,Iacki->Iabij',I.vovo, U2nold[0], optimize = True)
    ...
    U2n[0] += 1.0*einsum('akci,bk,Icj->Iabij',I.vovo, T1old, U1nold[0], optimize = True)
    U2n[0] += 1.0*einsum('akci,cj,Ibk->Iabij',I.vovo, T1old, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('akcj,bk,Ici->Iabij',I.vovo, T1old, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('akcj,ci,Ibk->Iabij',I.vovo, T1old, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bkci,ak,Icj->Iabij',I.vovo, T1old, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bkci,cj,Iak->Iabij',I.vovo, T1old, U1nold[0], optimize = True)
    U2n[0] += 1.0*einsum('bkcj,ak,Ici->Iabij',I.vovo, T1old, U1nold[0], optimize = True)
    U2n[0] += 1.0*einsum('bkcj,ci,Iak->Iabij',I.vovo, T1old, U1nold[0], optimize = True)
    ...
    U2n[0] += -0.5*einsum('akcd,bk,Idcji->Iabij',I.vovv, T1old, U2nold[0], optimize = True)
    U2n[0] += 1.0*einsum('akcd,di,Ibckj->Iabij',I.vovv, T1old, U2nold[0], optimize = True)
    U2n[0] += -1.0*einsum('akcd,dj,Ibcki->Iabij',I.vovv, T1old, U2nold[0], optimize = True)
    U2n[0] += 1.0*einsum('akcd,dk,Ibcji->Iabij',I.vovv, T1old, U2nold[0], optimize = True)
    U2n[0] += -1.0*einsum('akcd,bdji,Ick->Iabij',I.vovv, T2old, U1nold[0], optimize = True)
    U2n[0] += 1.0*einsum('akcd,bdki,Icj->Iabij',I.vovv, T2old, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('akcd,bdkj,Ici->Iabij',I.vovv, T2old, U1nold[0], optimize = True)
    U2n[0] += -0.5*einsum('akcd,dcji,Ibk->Iabij',I.vovv, T2old, U1nold[0], optimize = True)
    U2n[0] += 0.5*einsum('bkcd,ak,Idcji->Iabij',I.vovv, T1old, U2nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bkcd,di,Iackj->Iabij',I.vovv, T1old, U2nold[0], optimize = True)
    U2n[0] += 1.0*einsum('bkcd,dj,Iacki->Iabij',I.vovv, T1old, U2nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bkcd,dk,Iacji->Iabij',I.vovv, T1old, U2nold[0], optimize = True)
    U2n[0] += 1.0*einsum('bkcd,adji,Ick->Iabij',I.vovv, T2old, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bkcd,adki,Icj->Iabij',I.vovv, T2old, U1nold[0], optimize = True)
    U2n[0] += 1.0*einsum('bkcd,adkj,Ici->Iabij',I.vovv, T2old, U1nold[0], optimize = True)
    U2n[0] += 0.5*einsum('bkcd,dcji,Iak->Iabij',I.vovv, T2old, U1nold[0], optimize = True)
    ...
    U2n[0] += 1.0*einsum('akcd,di,bk,Icj->Iabij',I.vovv, T1old, T1old, U1nold[0], optimize = True)
    U2n[0] += 1.0*einsum('akcd,di,cj,Ibk->Iabij',I.vovv, T1old, T1old, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('akcd,dj,bk,Ici->Iabij',I.vovv, T1old, T1old, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bkcd,di,ak,Icj->Iabij',I.vovv, T1old, T1old, U1nold[0], optimize = True)
    U2n[0] += -1.0*einsum('bkcd,di,cj,Iak->Iabij',I.vovv, T1old, T1old, U1nold[0], optimize = True)
    U2n[0] += 1.0*einsum('bkcd,dj,ak,Ici->Iabij',I.vovv, T1old, T1old, U1nold[0], optimize = True)
    ...
    U22 += -1.0*einsum('bkji,ak->abij',I.vooo, U12old, optimize = True)
    U22 += 1.0*einsum('akji,bk->abij',I.vooo, U12old, optimize = True)
    U22 += 1.0*einsum('baci,cj->abij',I.vvvo, U12old, optimize = True)
    U22 += -1.0*einsum('bacj,ci->abij',I.vvvo, U12old, optimize = True)
    ...
    U22 += -1.0*einsum('bkci,ackj->abij',I.vovo, U22old, optimize = True)
    U22 += 1.0*einsum('akci,bckj->abij',I.vovo, U22old, optimize = True)
    U22 += 1.0*einsum('bkcj,acki->abij',I.vovo, U22old, optimize = True)
    U22 += -1.0*einsum('akcj,bcki->abij',I.vovo, U22old, optimize = True)
    ...
    U22 += -1.0*einsum('bkci,cj,ak->abij',I.vovo, T1old, U12old, optimize = True)
    U22 += 1.0*einsum('akci,cj,bk->abij',I.vovo, T1old, U12old, optimize = True)
    U22 += -1.0*einsum('bkci,ak,cj->abij',I.vovo, T1old, U12old, optimize = True)
    U22 += 1.0*einsum('akci,bk,cj->abij',I.vovo, T1old, U12old, optimize = True)
    U22 += 1.0*einsum('bkcj,ci,ak->abij',I.vovo, T1old, U12old, optimize = True)
    U22 += -1.0*einsum('akcj,ci,bk->abij',I.vovo, T1old, U12old, optimize = True)
    U22 += 1.0*einsum('bkcj,ak,ci->abij',I.vovo, T1old, U12old, optimize = True)
    U22 += -1.0*einsum('akcj,bk,ci->abij',I.vovo, T1old, U12old, optimize = True)
    ...
    U22 += -1.0*einsum('bkcd,di,ackj->abij',I.vovv, T1old, U22old, optimize = True)
    U22 += 1.0*einsum('akcd,di,bckj->abij',I.vovv, T1old, U22old, optimize = True)
    U22 += 1.0*einsum('bkcd,dj,acki->abij',I.vovv, T1old, U22old, optimize = True)
    U22 += -1.0*einsum('akcd,dj,bcki->abij',I.vovv, T1old, U22old, optimize = True)
    U22 += 0.5*einsum('bkcd,ak,dcji->abij',I.vovv, T1old, U22old, optimize = True)
    U22 += -1.0*einsum('bkcd,dk,acji->abij',I.vovv, T1old, U22old, optimize = True)
    U22 += -0.5*einsum('akcd,bk,dcji->abij',I.vovv, T1old, U22old, optimize = True)
    U22 += 1.0*einsum('akcd,dk,bcji->abij',I.vovv, T1old, U22old, optimize = True)
    U22 += 1.0*einsum('bkcd,adji,ck->abij',I.vovv, T2old, U12old, optimize = True)
    U22 += 0.5*einsum('bkcd,dcji,ak->abij',I.vovv, T2old, U12old, optimize = True)
    U22 += -1.0*einsum('akcd,bdji,ck->abij',I.vovv, T2old, U12old, optimize = True)
    U22 += -0.5*einsum('akcd,dcji,bk->abij',I.vovv, T2old, U12old, optimize = True)
    U22 += -1.0*einsum('bkcd,adki,cj->abij',I.vovv, T2old, U12old, optimize = True)
    U22 += 1.0*einsum('akcd,bdki,cj->abij',I.vovv, T2old, U12old, optimize = True)
    U22 += 1.0*einsum('bkcd,adkj,ci->abij',I.vovv, T2old, U12old, optimize = True)
    U22 += -1.0*einsum('akcd,bdkj,ci->abij',I.vovv, T2old, U12old, optimize = True)
    ...
    U22 += -2.0*einsum('bkci,cj,ak->abij',I.vovo, U11old, U11old, optimize = True)
    U22 += 2.0*einsum('akci,cj,bk->abij',I.vovo, U11old, U11old, optimize = True)
    U22 += 2.0*einsum('bkcj,ci,ak->abij',I.vovo, U11old, U11old, optimize = True)
    U22 += -2.0*einsum('akcj,ci,bk->abij',I.vovo, U11old, U11old, optimize = True)
    ...
    U22 += -2.0*einsum('bkcd,di,ackj->abij',I.vovv, U11old, U21old, optimize = True)
    U22 += 2.0*einsum('akcd,di,bckj->abij',I.vovv, U11old, U21old, optimize = True)
    U22 += 2.0*einsum('bkcd,dj,acki->abij',I.vovv, U11old, U21old, optimize = True)
    U22 += -2.0*einsum('akcd,dj,bcki->abij',I.vovv, U11old, U21old, optimize = True)
    U22 += 1.0*einsum('bkcd,ak,dcji->abij',I.vovv, U11old, U21old, optimize = True)
    U22 += -2.0*einsum('bkcd,dk,acji->abij',I.vovv, U11old, U21old, optimize = True)
    U22 += -1.0*einsum('akcd,bk,dcji->abij',I.vovv, U11old, U21old, optimize = True)
    U22 += 2.0*einsum('akcd,dk,bcji->abij',I.vovv, U11old, U21old, optimize = True)
    ...
    U22 += -1.0*einsum('bkcd,di,cj,ak->abij',I.vovv, T1old, T1old, U12old, optimize = True)
    U22 += 1.0*einsum('akcd,di,cj,bk->abij',I.vovv, T1old, T1old, U12old, optimize = True)
    U22 += -1.0*einsum('bkcd,di,ak,cj->abij',I.vovv, T1old, T1old, U12old, optimize = True)
    U22 += 1.0*einsum('akcd,di,bk,cj->abij',I.vovv, T1old, T1old, U12old, optimize = True)
    U22 += 1.0*einsum('bkcd,dj,ak,ci->abij',I.vovv, T1old, T1old, U12old, optimize = True)
    U22 += -1.0*einsum('akcd,dj,bk,ci->abij',I.vovv, T1old, T1old, U12old, optimize = True)
    ...
    U22 += -2.0*einsum('bkcd,di,cj,ak->abij',I.vovv, T1old, U11old, U11old, optimize = True)
    U22 += 2.0*einsum('akcd,di,cj,bk->abij',I.vovv, T1old, U11old, U11old, optimize = True)
    U22 += 2.0*einsum('bkcd,dj,ci,ak->abij',I.vovv, T1old, U11old, U11old, optimize = True)
    U22 += -2.0*einsum('akcd,dj,ci,bk->abij',I.vovv, T1old, U11old, U11old, optimize = True)
    U22 += -2.0*einsum('bkcd,ak,di,cj->abij',I.vovv, T1old, U11old, U11old, optimize = True)
    U22 += 2.0*einsum('akcd,bk,di,cj->abij',I.vovv, T1old, U11old, U11old, optimize = True)
...
def single_qedccsd_U1n(F, I, w, g, h, G, H, nfock1, nfock2, amps):
    ...
    U11 += -1.0*einsum('ajbi,bj->ai',I.vovo, U11old, optimize = True)
    if nfock1 > 1:
    ...
    U11 += -1.0*einsum('ajbc,ci,bj->ai',I.vovv, T1old, U11old, optimize = True)
    U11 += 1.0*einsum('ajbc,cj,bi->ai',I.vovv, T1old, U11old, optimize = True)
    if nfock2 > 1:
    ...
    if U2nold[0] is not None:
        ...
        U11 += 0.5*einsum('ajbc,cbji->ai',I.vovv, U21old, optimize = True)
    ...
    U12 += 1.0 * einsum('ab,bi->ai', g.vv[0], U11old, optimize = True)
    U12 += -1.0*einsum('ajbi,bj->ai',I.vovo, U12old, optimize = True)
    ...
    U12 += -1.0*einsum('ajbc,ci,bj->ai',I.vovv, T1old, U12old, optimize = True)
    U12 += 1.0*einsum('ajbc,cj,bi->ai',I.vovv, T1old, U12old, optimize = True)
    ...
    U12 += -2.0*einsum('ajbc,ci,bj->ai',I.vovv, U11old, U11old, optimize = True)
    ...
    if U2nold[0] is not None: # when reach here, nfock is at least 2
        ...
        U12 += 0.5*einsum('ajbc,cbji->ai',I.vovv, U22old, optimize = True)
...
def single_qedccsd_U2n(F, I, w, g, h, G, H, nfock1, nfock2, amps):
    ...
    U21 += -1.0*einsum('bkji,ak->abij',I.vooo, U11old, optimize = True)
    U21 += 1.0*einsum('akji,bk->abij',I.vooo, U11old, optimize = True)
    U21 += 1.0*einsum('baci,cj->abij',I.vvvo, U11old, optimize = True)
    U21 += -1.0*einsum('bacj,ci->abij',I.vvvo, U11old, optimize = True)
    ...
    U21 += -1.0*einsum('bkci,cj,ak->abij',I.vovo, T1old, U11old, optimize = True)
    U21 += 1.0*einsum('akci,cj,bk->abij',I.vovo, T1old, U11old, optimize = True)
    U21 += -1.0*einsum('bkci,ak,cj->abij',I.vovo, T1old, U11old, optimize = True)
    U21 += 1.0*einsum('akci,bk,cj->abij',I.vovo, T1old, U11old, optimize = True)
    U21 += 1.0*einsum('bkcj,ci,ak->abij',I.vovo, T1old, U11old, optimize = True)
    U21 += -1.0*einsum('akcj,ci,bk->abij',I.vovo, T1old, U11old, optimize = True)
    U21 += 1.0*einsum('bkcj,ak,ci->abij',I.vovo, T1old, U11old, optimize = True)
    U21 += -1.0*einsum('akcj,bk,ci->abij',I.vovo, T1old, U11old, optimize = True)
    ...
    U21 += -1.0*einsum('bkci,ackj->abij',I.vovo, U21old, optimize = True)
    U21 += 1.0*einsum('akci,bckj->abij',I.vovo, U21old, optimize = True)
    U21 += 1.0*einsum('bkcj,acki->abij',I.vovo, U21old, optimize = True)
    U21 += -1.0*einsum('akcj,bcki->abij',I.vovo, U21old, optimize = True)
    ...
    U21 += -1.0*einsum('bkcd,di,ackj->abij',I.vovv, T1old, U21old, optimize = True)
    U21 += 1.0*einsum('akcd,di,bckj->abij',I.vovv, T1old, U21old, optimize = True)
    U21 += 1.0*einsum('bkcd,dj,acki->abij',I.vovv, T1old, U21old, optimize = True)
    U21 += -1.0*einsum('akcd,dj,bcki->abij',I.vovv, T1old, U21old, optimize = True)
    U21 += 0.5*einsum('bkcd,ak,dcji->abij',I.vovv, T1old, U21old, optimize = True)
    U21 += -1.0*einsum('bkcd,dk,acji->abij',I.vovv, T1old, U21old, optimize = True)
    U21 += -0.5*einsum('akcd,bk,dcji->abij',I.vovv, T1old, U21old, optimize = True)
    U21 += 1.0*einsum('akcd,dk,bcji->abij',I.vovv, T1old, U21old, optimize = True)

    U21 += 1.0*einsum('bkcd,adji,ck->abij',I.vovv, T2old, U11old, optimize = True)
    U21 += 0.5*einsum('bkcd,dcji,ak->abij',I.vovv, T2old, U11old, optimize = True)
    U21 += -1.0*einsum('akcd,bdji,ck->abij',I.vovv, T2old, U11old, optimize = True)
    U21 += -0.5*einsum('akcd,dcji,bk->abij',I.vovv, T2old, U11old, optimize = True)
    U21 += -1.0*einsum('bkcd,adki,cj->abij',I.vovv, T2old, U11old, optimize = True)
    U21 += 1.0*einsum('akcd,bdki,cj->abij',I.vovv, T2old, U11old, optimize = True)
    U21 += 1.0*einsum('bkcd,adkj,ci->abij',I.vovv, T2old, U11old, optimize = True)
    U21 += -1.0*einsum('akcd,bdkj,ci->abij',I.vovv, T2old, U11old, optimize = True)
    ...
    U21 += -1.0*einsum('bkcd,di,cj,ak->abij',I.vovv, T1old, T1old, U11old, optimize = True)
    U21 += 1.0*einsum('akcd,di,cj,bk->abij',I.vovv, T1old, T1old, U11old, optimize = True)
    U21 += -1.0*einsum('bkcd,di,ak,cj->abij',I.vovv, T1old, T1old, U11old, optimize = True)
    U21 += 1.0*einsum('akcd,di,bk,cj->abij',I.vovv, T1old, T1old, U11old, optimize = True)
    U21 += 1.0*einsum('bkcd,dj,ak,ci->abij',I.vovv, T1old, T1old, U11old, optimize = True)
    U21 += -1.0*einsum('akcd,dj,bk,ci->abij',I.vovv, T1old, T1old, U11old, optimize = True)
