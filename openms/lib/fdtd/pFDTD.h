...
void set_sigma_order(float oxl, float oxr, float oyl, float oyr, float ozl,
                     float ozr);
void set_sigma_max(float axl, float axr, float ayl, float ayr, float azl,
                   float azr);
...
void input_molecular(char *shape, float centerx, float centery, float centerz,
                     float size1, float size2, float size3);
void input_Drude_medium(char *shape, float centerx, float centery,
                        float centerz, float size1, float size2, float size3,
                        float epsilon_b, float omega_p, float gamma_0,
                        float lattice_n);
void input_Drude_medium2(char *shape, char *matrix_file, float centerx,
                         float centery, float centerz, float size1, float size2,
                         float size3, float epsilon_b, float omega_p,
                         float gamma_0, float lattice_n);
...
void Gaussian_dipole_source(char *component, float x, float y, float z,
                            float frequency, float phaes, long to, long tdecay);
...
void Lorentzian_dipole_source(char *component, float x, float y, float z,
                              float frequency, float phaes, long to,
                              long tdecay);
float Lorentzian_phase(float Wn, long tdecay);
float Gaussian_phase(float Wn, long t_peak);
void incoherent_point_dipole(char *function, float x, float y, float z,
                             float frequency, long to, long tdecay, float t_mu,
                             float sd);
float eps(int i, int j, int k);
float eps_m(int i, int j,
            int k); // effective epsilon for Drude dispersive material
