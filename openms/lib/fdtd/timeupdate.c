...
void coefficient_cpml()
{
    ...
    for(i=0;i<misize;i++)
    {
        ...
        if(i>isize/2) ggx[i] = cpmlax(i-0.5,pmlil,pmlir);
        if(i>isize/2) hhx[i] = cpmlbx(i-0.5,pmlil,pmlir);
        if(i>isize/2) ffx[i] =kappa_x(i-0.5,pmlil,pmlir);
    ...
    for(j=0;j<mjsize;j++)
    {
        ...
        if(j>jsize/2) ggy[j] = cpmlax(j-0.5,pmljl,pmljr);
        if(j>jsize/2) hhy[j] = cpmlbx(j-0.5,pmljl,pmljr);
        if(j>jsize/2) ffy[j] =kappa_x(j-0.5,pmljl,pmljr);
    ...
    for(k=0;k<mksize;k++)
    {
        ...
        if(k>ksize/2) ggz[k] = cpmlax(k-0.5,pmlkl,pmlkr);
        if(k>ksize/2) hhz[k] = cpmlbx(k-0.5,pmlkl,pmlkr);
        if(k>ksize/2) ffz[k] =kappa_x(k-0.5,pmlkl,pmlkr);
...
void E_field_periodic_boundary_update_Ywall() ////// for triangular lattice 
{
    ...
    for(k=1;k<pksize;k++)
    {
        Ey[i][0][k]=Ey[i+Uxh][jsize][k]*cos_ph1+iEy[i+Uxh][jsize][k]*sin_ph1;
        Ex[i+Uxh][jsize+1][k]=Ex[i][1][k]*cos_ph1-iEx[i][1][k]*sin_ph1;
        Ez[i+Uxh][jsize+1][k]=Ez[i][1][k]*cos_ph1-iEz[i][1][k]*sin_ph1;

        iEy[i][0][k]=-Ey[i+Uxh][jsize][k]*sin_ph1+iEy[i+Uxh][jsize][k]*cos_ph1;
        iEx[i+Uxh][jsize+1][k]=Ex[i][1][k]*sin_ph1+iEx[i][1][k]*cos_ph1;
        iEz[i+Uxh][jsize+1][k]=Ez[i][1][k]*sin_ph1+iEz[i][1][k]*cos_ph1;
    }

    for(i=pisize-Uxh;i<pisize;i++)
    for(k=1;k<pksize;k++)
    {
        Ey[i][0][k]=Ey[i-Uxh][jsize][k]*cos_ph2+iEy[i-Uxh][jsize][k]*sin_ph2;
        Ex[i-Uxh][jsize+1][k]=Ex[i][1][k]*cos_ph2-iEx[i][1][k]*sin_ph2;
        Ez[i-Uxh][jsize+1][k]=Ez[i][1][k]*cos_ph2-iEz[i][1][k]*sin_ph2;

        iEy[i][0][k]=-Ey[i-Uxh][jsize][k]*sin_ph2+iEy[i-Uxh][jsize][k]*cos_ph2;
        iEx[i-Uxh][jsize+1][k]=Ex[i][1][k]*sin_ph2+iEx[i][1][k]*cos_ph2;
        iEz[i-Uxh][jsize+1][k]=Ez[i][1][k]*sin_ph2+iEz[i][1][k]*cos_ph2;
    }
}
...
void H_field_periodic_boundary_update_Ywall()  ///// for triangular lattice
{
    ...
    for(k=1;k<pksize;k++)
    {
        Hy[i+Uxh][jsize+1][k]=Hy[i][1][k]*cos_ph1-iHy[i][1][k]*sin_ph1;
        Hx[i][0][k]=Hx[i+Uxh][jsize][k]*cos_ph1+iHx[i+Uxh][jsize][k]*sin_ph1;
        Hz[i][0][k]=Hz[i+Uxh][jsize][k]*cos_ph1+iHz[i+Uxh][jsize][k]*sin_ph1;

        iHy[i+Uxh][jsize+1][k]=Hy[i][1][k]*sin_ph1+iHy[i][1][k]*cos_ph1;
        iHx[i][0][k]=-Hx[i+Uxh][jsize][k]*sin_ph1+iHx[i+Uxh][jsize][k]*cos_ph1;
        iHz[i][0][k]=-Hz[i+Uxh][jsize][k]*sin_ph1+iHz[i+Uxh][jsize][k]*cos_ph1;
    }

    for(i=pisize-Uxh;i<pisize;i++)
    for(k=1;k<pksize;k++)
    {
        Hy[i-Uxh][jsize+1][k]=Hy[i][1][k]*cos_ph2-iHy[i][1][k]*sin_ph2;
        Hx[i][0][k]=Hx[i-Uxh][jsize][k]*cos_ph2+iHx[i-Uxh][jsize][k]*sin_ph2;
        Hz[i][0][k]=Hz[i-Uxh][jsize][k]*cos_ph2+iHz[i-Uxh][jsize][k]*sin_ph2;

        iHy[i-Uxh][jsize+1][k]=Hy[i][1][k]*sin_ph2+iHy[i][1][k]*cos_ph2;
        iHx[i][0][k]=-Hx[i-Uxh][jsize][k]*sin_ph2+iHx[i-Uxh][jsize][k]*cos_ph2;
        iHz[i][0][k]=-Hz[i-Uxh][jsize][k]*sin_ph2+iHz[i-Uxh][jsize][k]*cos_ph2;
    }
}
