...
void input_Drude_medium(char *shape, float centerx, float centery,
  ...
  if (strcmp(shape, "rod") == 0) {
    ...
    mobject[mobjn - 1].size2 =
        (size2); // height  // for non_uniform_grid(), the meaning changed
             ...
             0) //// not applicable for non_uniform_grid()
  {
    ...
    mobject[mobjn - 1].size3 =
        (size3); // height  // for non_uniform_grid(), the meaning changed
...
int in_mobject(int n, float i, float j, float k) {
  ...
  if (strcmp(mobject[n].shape, "rod") == 0) {
    if ((i - mobject[n].centeri) * (i - mobject[n].centeri) +
                (j - mobject[n].centerj) * (j - mobject[n].centerj) <=
            mobject[n].size1 * mobject[n].size1 &&
        non_uniform_z_to_i(mobject[n].centerk - 0.5 * mobject[n].size2) <= k &&
        k <= non_uniform_z_to_i(mobject[n].centerk + 0.5 * mobject[n].size2))
      return 1;
    else
      return 0;
  }
    ...
    if ((i - mobject[n].centeri) * (i - mobject[n].centeri) < 1.E-6) {
      if ((j - mobject[n].centerj) * (j - mobject[n].centerj) < 1.E-6 &&
          (k - mobject[n].centerk) * (k - mobject[n].centerk) < 1.E-6)
        printf("test1 %f %f %f \n", i, j, k);
    }

    if ((i - mobject[n].centeri) * (i - mobject[n].centeri) +
            (j - mobject[n].centerj) * (j - mobject[n].centerj) +
            (k - mobject[n].centerk) * (k - mobject[n].centerk) <
        1.E-6)
      return 1;
    else
      return 0;
    ...
    if ((j - mobject[n].centerj) * (j - mobject[n].centerj) +
                (k - mobject[n].centerk) * (k - mobject[n].centerk) <=
            mobject[n].size1 * mobject[n].size1 &&
        mobject[n].centeri - mobject[n].size2 / 2 <= i &&
        i <= mobject[n].centeri + mobject[n].size2 / 2)
      return 1;
    else
      return 0;
  }
    ...
    if ((k - mobject[n].centerk) * (k - mobject[n].centerk) +
                (i - mobject[n].centeri) * (i - mobject[n].centeri) <=
            mobject[n].size1 * mobject[n].size1 &&
        mobject[n].centerj - mobject[n].size2 / 2 <= j &&
        j <= mobject[n].centerj + mobject[n].size2 / 2)
      return 1;
    else
      return 0;
  }
    ...
    if ((i - mobject[n].centeri) * (i - mobject[n].centeri) +
        ...
        (i - mobject[n].centeri) * (i - mobject[n].centeri) +
                (j - mobject[n].centerj) * (j - mobject[n].centerj) <=
            mobject[n].size2 * mobject[n].size2 &&
        non_uniform_z_to_i(mobject[n].centerk - 0.5 * mobject[n].size3) <= k &&
        k <= non_uniform_z_to_i(mobject[n].centerk + 0.5 * mobject[n].size3))
      return 1;
    else
      return 0;
  }
    ...
    if ((i - mobject[n].centeri) * (i - mobject[n].centeri) +
                (j - mobject[n].centerj) * (j - mobject[n].centerj) /
                    (mobject[n].size3 * mobject[n].size3) <=
            mobject[n].size1 * mobject[n].size1 &&
        non_uniform_z_to_i(mobject[n].centerk - 0.5 * mobject[n].size2) <= k &&
        k <= non_uniform_z_to_i(mobject[n].centerk + 0.5 * mobject[n].size2))
      return 1;
    ...
    //  size3 : height
    ///////////////////////////////////////////////
    temp = (mobject[n].size1 - mobject[n].size2) *
               (non_uniform_i_to_z(k) - mobject[n].centerk) / mobject[n].size3 +
           0.5 * (mobject[n].size1 +
                  mobject[n].size2); // radius varying as a function of 'k'

    if ((i - mobject[n].centeri) * (i - mobject[n].centeri) +
                (j - mobject[n].centerj) * (j - mobject[n].centerj) <=
            temp * temp &&
        (k <=
         non_uniform_z_to_i(mobject[n].centerk + 0.5 * mobject[n].size3)) &&
        (k >= non_uniform_z_to_i(mobject[n].centerk - 0.5 * mobject[n].size3)))
      return 1;
    else
      return 0;
    ...
    if (mobject[n].centeri - mobject[n].size1 / 2 <= i &&
        i <= mobject[n].centeri + mobject[n].size1 / 2 &&
        mobject[n].centerj - mobject[n].size2 / 2 <= j &&
        j <= mobject[n].centerj + mobject[n].size2 / 2 &&
        non_uniform_z_to_i(mobject[n].centerk - 0.5 * mobject[n].size3) <= k &&
        k <= non_uniform_z_to_i(mobject[n].centerk + 0.5 * mobject[n].size3))
    ...
    if ((-mobject[n].centeri * CUTFACTOR <=
         (i - (xcenter * lattice_x)) / mobject[n].size3) &&
        ((i - (xcenter * lattice_x)) / mobject[n].size3 <=
         (mobject[n].col - mobject[n].centeri) * CUTFACTOR) &&
        (-mobject[n].centerj * CUTFACTOR <=
         (j - (ycenter * lattice_y)) / mobject[n].size3) &&
        ((j - (ycenter * lattice_y)) / mobject[n].size3 <=
         (mobject[n].row - mobject[n].centerj) * CUTFACTOR) &&
        (non_uniform_z_to_i(mobject[n].centerk - 0.5 * mobject[n].size2) <=
         k) &&
        (k <=
         non_uniform_z_to_i(mobject[n].centerk + 0.5 * mobject[n].size2))) {
      I = floor(mobject[n].centeri +
                (i - (xcenter * lattice_x)) / mobject[n].size3);
      J = floor(mobject[n].centerj +
                (j - (ycenter * lattice_y)) / mobject[n].size3);
